...
const Color secondaryColor = Color(0xFF264653);
const Color accentColor = Color(0xFFE76F51);
const Color errorColor = Color(0xFFE85151);
const Color warningColor = Color(0xFFF48561);
const Color successColor = Color(0xFF2A9D8F);
const Color disabledColor = Color(0xFFDDD1CB);
